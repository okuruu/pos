...
<div class="card card-flush shadow-sm mb-7">
    ...
    <div class="card-body py-5">
        ...
        <div class="row">
            ...
            <div class="col-md-2 fv-row">
                <button type="button" on:click={doSearch} class="btn btn-sm btn-primary mt-8"><i class="las la-search fs-2 me-2"></i>Cari Kas Keluar</button>
            </div>
        </div>
